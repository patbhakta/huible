...
@pytest.fixture
def queue() -> QuarantineQueue:
    return QuarantineQueue(store=InMemoryQuarantineStore())
...
def make_node(
    ...
    return MemoryNode(
        ...
        embedding_content=embedding_content or [0.0],
        memory_date=memory_date or date(2015, 7, 15),
